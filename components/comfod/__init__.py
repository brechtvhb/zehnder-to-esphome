...
cv.Optional(CONF_FAN_SPEED_EXHAUST): sensor.sensor_schema(nit_of_measurement=UNIT_REVOLUTIONS_PER_MINUTE, accuracy_decimals=0, state_class=STATE_CLASS_MEASUREMENT).extend(),
